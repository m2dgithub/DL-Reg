'''Train MNIST with PyTorch using the proposed regularizer.'''
import torch
...
net = mlp_relu(in_ch=784, num_classes=10)          # Running model is a simple MLP with a ReLu activation
...
# Training
print('Training on MNIST using the proposed regularizer...')
